...
interface TermDeleteConfirmModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function TermDeleteConfirmModal({
  isOpen,
  onClose,
}: TermDeleteConfirmModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-center font-bold text-xl mb-3">本当に削除しますか？</p>
