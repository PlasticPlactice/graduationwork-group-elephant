    ...
    return (
        <div className={`${Styles.posterContainer} py-10`}>
            ...
            <div className={`text-center py-6 ${Styles.userIdContainer}`} >
                <p className={`font-bold ${Styles.text16px} ${Styles.subColor}`}>ユーザーID</p>
                <div className='flex items-center justify-center gap-4'>
                    <input id='userId' ref={inputRef} defaultValue={"0000000000"} className={`font-bold ${Styles.userId}`}/>
                    {/* コピペのボタン */}
                    <button onClick={copyToUserId} className={`${Styles.copyButton} border rounded-full `}>
