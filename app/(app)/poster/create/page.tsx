    ...
    return (
        <>
            <div className={`${styles.posterContainer}`}>
                <p className={`font-bold text-center mt-12 ${styles.text24px}`}>アカウントを作成</p>
                <Link href="/poster/login" className={`block mt-4 text-center font-bold ${styles.linkText}`}><span className={`border-b ${styles.linkText}`}>既にアカウントをお持ちの方はこちら</span></Link>
                ...
                <form action="" method="post">
                    ...
                    {/* 利用規約 */}
                    <div className="my-12">
                        <div className={`border w-full rounded-sm px-9 py-9 ${styles.subColor}`}>
                            <p className="text-center mx-auto  text-red-500 font-bold">本サービスご利用のためには、利用規約に同意していただく必要があります。</p>
                            <button type="button" className={`w-full my-5 ${styles.barcodeScan__backButton}`} onClick={() => setHelpOpen(true)}>利用規約</button>

                            <Modal open={helpOpen} onClose={() => setHelpOpen(false)}>
                                <p className={`font-bold ${styles.text24px} ${styles.mainColor}`}>利用規約</p>
                                <div className={`border border-b rounded-sm ${styles.mainColor}`}></div>
                                <div className="h-96 my-5 overflow-y-scroll">
                                    <p className={styles.text14px}>
                                        ...
                                        第14条（準拠法・裁判管轄）
                                        本規約の解釈には、日本法を適用します。
                                        本サービスに関する紛争は、当社所在地を管轄する裁判所を第一審の専属的合意管轄とします。<br/>
                                        以上
                                    </p>
                                </div>
                                <button
                            ...
                            <div className="flex items-center mt-3">
                                ...
                                <label htmlFor="terms" className="ml-2 text-black">利用規約を理解し、同意します。</label>
                            </div>
                        </div>
                    ...
                    <div className="my-8">
                        <Link href="/poster/create-complete">
                            <button disabled={!isTermsAccepted} type="button" className={`w-full ${isTermsAccepted ? "font-bold" : `${styles.disabledButton}`}`}>登録</button>
                        </Link>
                    </div>
                </form>
            </div>
