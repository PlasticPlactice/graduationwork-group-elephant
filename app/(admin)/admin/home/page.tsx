    ...
    return (
        <main className="home-main">
            ...
            <div className='grid grid-cols-2 grid-rows-2 m-auto w-max gap-x-14 gap-y-10 mt-18'>
                {/* お知らせ・寄贈管理 */}
                <div className='flex p-2 shadow-md w-max admin-card'>
                ...
                {/* イベント管理 */}
                <div className='flex py-2 pl-2 shadow-md w-max admin-card'>
                    <div className='flex items-center justify-center w-auto mx-1'>
                ...
                {/* ユーザー管理 */}
                <div className='flex py-2 pl-2 pr-5 shadow-md w-max admin-card'>
                    <div className='flex items-center justify-center w-auto mx-1'>
